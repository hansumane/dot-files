...
# fzf colors (lackluster)
export FZF_DEFAULT_OPTS=" \
--color=bg+:#272727,bg:#080808,spinner:#D7007D,hl:#789978 \
--color=fg:#DEEEED,header:#D70000,info:#7788AA,pointer:#7788AA \
--color=marker:#789978,fg+:#DEEEED,prompt:#7788AA,hl+:#8BB48B \
--color=selected-bg:#272727 \
--border top --multi"

# eza colors (lackluster)
