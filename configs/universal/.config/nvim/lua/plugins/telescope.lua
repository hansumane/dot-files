...
return {
  ...
  config = function()
    ...
    map { mods = 'n', map = '<leader>b', opts = { silent = true }, cmd = builtin.buffers }
    map { mods = 'n', map = '<leader>se', opts = { silent = true }, cmd = builtin.live_grep }
    map { mods = 'n', map = '<leader>sf', opts = { silent = true }, cmd = builtin.find_files }
  end
}
